...
def answer_four():
    ...
    # Your code here
    SVC_cl=SVC(C= 1e9, gamma=1e-07).fit(X_train, y_train)
    pred = SVC_cl.decision_function(X_test) > -220
...
def answer_six():    
    ...
    clf = GridSearchCV(model, param,scoring='recall')
    clf.fit(X_train,y_train)
    means = clf.cv_results_['mean_test_score']
    #print(means.reshape(5,2))
    return means.reshape(5,2)
